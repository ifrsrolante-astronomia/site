...
instagram: diegooilv # insira só o handle, sem @
...
- 💻 **Programação** — experiência com **Node.js**, **MongoDB**, **Java** e **HTML/CSS/JS**.
- 📚 **Educação** — acredito que a tecnologia pode transformar o aprendizado e aproximar as pessoas.

## Projetos Pessoais

- **Sites e APIs**: crio projetos usando **Node.js** e **Next.js**.
